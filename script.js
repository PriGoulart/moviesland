const API_KEY = '98b568247c993c8cf21afa820938b587';
            ...
            texto = texto + `
                <div class="carousel-item active">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 text">
                        ...
                        <a href="https://www.themoviedb.org/movie/${filme.id}"><button type="button" class="btn btn-outline-secondary">Leia mais...</button></a>
                    </div>
                </div>
            `;
        }
